...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Товари</span>
            <x-side-nav-link link="{{ route('admin.products.index') }}" icon="bx-cart-alt" name="Товари" />
            <x-side-nav-link link="{{ route('admin.products.create') }}" icon="bx-list-plus" name="Додати товар" />
        </li>
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Зображення</span>
            <x-side-nav-link link="{{ route('admin.images.index') }}" icon="bx-image-alt" name="Зображення" />
            <x-side-nav-link link="{{ route('admin.images.create') }}" icon="bx-image-add" name="Додати зображення" />
        </li>
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Користувачі</span>
            <x-side-nav-link link="{{ route('admin.users.index') }}" icon="bxs-user-detail" name="Користувачі" />
            <x-side-nav-link link="{{ route('admin.users.create') }}" icon="bx-user-plus" name="Створити користувача" />
        </li>
    </ul>
</aside>
<!-- / Menu -->
